...
public class ProductController {
	...
	@GetMapping("/series")
	public PageResponse<ProductListDto> listProductsBySeries(@RequestParam String name, Pageable pageable) {
		return service.listProductsBySeries(name, pageable);
	}
	
	@GetMapping("/home-page")
	public List<ProductCard> listProducts() {
		return service.getHomePageProducts();
	}
